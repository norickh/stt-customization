...
//	private JTextField inEndpoint;
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("Speech To Text Cutomize ver.8");
		...
		inUsername.setText("80c55ecb-9c6e-40d9-94a2-094d705fecc3");
		...
		inPassword.setText("QbVVGDfTk3bW");
		...
		btnDeleteAll.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				stt.CLMList clmList = new CLMList(inUsername.getText(), inPassword.getText(), (String) comboEndPoint.getSelectedItem());
